...
fn test_kat_block1() {
    ...
    let ctxt =
        secret_bytes!([0x3a, 0xd7, 0x7b, 0xb4, 0x0d, 0x7a, 0x36, 0x60, 0xa8, 0x9e, 0xca, 0xf3, 0x24, 0x66, 0xef, 0x97]);
...
fn test_kat_block2() {
    ...
    let ctxt = ByteSeq::from_array(&secret_bytes!([
        0x61, 0x5f, 0x09, 0xfb, 0x35, 0x3f, 0x61, 0x3b, 0xa2, 0x8f, 0xf3, 0xa3, 0x0c, 0x64, 0x75, 0x2d
    ]));
    let c = aes128_encrypt_block(key, msg);
    assert_bytes_eq!(ctxt, c);
}
